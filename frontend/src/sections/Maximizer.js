  ...
  return (
    <div className="p-6 md:p-12 max-w-[1200px]">
        ...
        {plan && (
          <div className="mt-5 pt-4 border-t" style={{ borderColor: "var(--border)" }} data-testid="game-planner">
            ...
            <div className="flex flex-wrap items-center gap-5 mt-4">
              ...
              <label className="text-xs flex items-center gap-2" style={{ color: "var(--text-secondary)" }}>
                Codes expire
                <select data-testid="code-expiry-select" value={plan.settings.codeExpiryDays}
              ...
              <span className="text-xs" style={{ color: "var(--text-secondary)" }}>
                Won this week? Codes die after {plan.settings.codeExpiryDays} days — no stockpiling plays.
              </span>
            </div>
          </div>
        )}
      ...
      <div className="card p-6 md:p-8 mt-8" data-testid="verification">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
          <div><Overline>Codes Issued</Overline><div className="mono text-2xl" data-testid="ledger-issued">{segments.verification.codesIssued}</div></div>
          <div><Overline>Codes Redeemed</Overline><div className="mono text-2xl" style={{ color: "var(--primary)" }} data-testid="ledger-redeemed">{segments.verification.codesRedeemed}</div></div>
